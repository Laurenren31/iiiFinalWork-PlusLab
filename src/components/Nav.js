...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <Link to="/" onClick={colorCourse} id="disable">
        課程列表
      </Link>
      <Link to="/profile/ownCourse" onClick={colorMycourse} id="disable">
        我的課程
      </Link>
      ...
      <Link to="/" onClick={colorShoppingCart} id="disable">
        <svg
      ...
      <Link to="/" onClick={colorNone} id="disable">
        <svg
          className="alert"
          width="21"
          height="24"
      ...
      <div className="profilePic">
        ...
        <div>
          ...
          <ul className="dropDown">
            <Link to="/" onClick={colorNone} id="disableProfileRed">
              <li>
                <div className="listbox">
                  <img src={coupon} alt="" id="disableList" />
                  <span id="disableList">領折扣</span>
                </div>
              </li>
            </Link>
            ...
            <Link to="/" onClick={colorNone} id="disableProfileBlue">
              <li>
                <div className="listbox">
                  <img src={history} alt="" id="disableList" />
                  <span id="disableList">課程訂單</span>
                </div>
              </li>
            </Link>
            <Link to="/" onClick={colorNone} id="disableProfileBlue">
              <li className="backStage">
                <div className="listbox">
                  <img src={backStage} alt="" id="disableList" />
                  <span id="disableList">後臺資料</span>
                </div>
              </li>
            </Link>
            <Link
