        ...
        <label htmlFor="stockKey">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              const foundData = myStockCollection.find(
                (item) => item.stockKey === e.target.value
              );
              if (foundData) {
                setStockName(foundData.stockName);
              } else {
                setStockName("");
              }
            }}
        ...
        <label htmlFor="stockName">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              const foundData = myStockCollection.find(
                (item) => item.stockName === e.target.value
              );
              if (foundData) {
                setStockKey(foundData.stockKey);
              } else {
                setStockKey("");
              }
            }}
