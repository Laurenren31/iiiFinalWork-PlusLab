...
import feedBackProfilePic2 from "./homepageImg/feedBackProfilePic2.png";
import feedBackProfilePic3 from "./homepageImg/feedBackProfilePic3.png";
import feedBackProfilePic4 from "./homepageImg/feedBackProfilePic4.png";
    ...
    <div className="head4">
      ...
      <div className="feedBackRow1">
        ...
        <div className="feedBack2">
          ...
          <div className="feedBackAuthorBox">
            <img src={feedBackProfilePic2} alt="" />
            <h6>陳靜怡</h6>
          </div>
        </div>
      </div>
      <div className="feedBackRow2">
        <div className="feedBack3">
          ...
          <div className="feedBackAuthorBox">
            <img src={feedBackProfilePic3} alt="" />
            <h6>江辰傑</h6>
          </div>
        </div>
        <div className="feedBack4">
          ...
          <div className="feedBackAuthorBox">
            <img src={feedBackProfilePic4} alt="" />
            <h6>Amy Wu</h6>
          </div>
        </div>
      </div>
